...
This program is an _ad hoc_ derivative of the *Demiurge_MultiQ_486* program developed in **Processing** and **Java**. It simulates ion motion within a single quadrupole of a 486-quadrupole MultiQ-IT ion trap, configured for m/z-dependent ion ejection from the MultiQ-IT. The computer model is based on the work by **A.N. Krutchinsky, I.V. Chernushevich, V.L. Spicer, W. Ens, and K.G. Standing**:  
